          ...
          <div className="flex flex-col  md:flex-row  md:items-start mb-6  md:mb-12">
            ...
            <div className="grid grid-cols-[auto,1fr] gap-0  md:grid-cols-1 w-full">
              <div className="relative flex flex-col w-4 mr-5 items-center justify-between row-span-2  md:rows-span-1  md:order-1  md:w-full  md:h-4  md:mr-0  md:my-2  md:flex-row">
                ...
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-blue-200 self-end z-10 -mb-1  md:mb-0  md:-mr-1  md:-rotate-90"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 14.879l-7.94-7.94a1.5 1.5 0 10-2.12 2.122l9 9a1.5 1.5 0 002.12 0l9-9a1.5 1.5 0 00-2.12-2.122L12 14.88z" fill="currentColor"></path><mask id="a" maskUnits="userSpaceOnUse" x="1" y="6" width="22" height="13"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 14.879l-7.94-7.94a1.5 1.5 0 10-2.12 2.122l9 9a1.5 1.5 0 002.12 0l9-9a1.5 1.5 0 00-2.12-2.122L12 14.88z" fill="#fff"></path></mask></svg>
